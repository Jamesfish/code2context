...
export function exportCursor(ctx: ProjectContext): string {
    ...
    // Footer
    lines.push(`# Generated by Code2Context v${ctx.generated.version} on ${ctx.generated.timestamp}`);
...
export function exportClaude(ctx: ProjectContext): string {
    ...
    lines.push('---');
    lines.push(`*Generated by [Code2Context](https://github.com/Jamesfish/code2context) v${ctx.generated.version}*`);
